...
CREATE TABLE lab7.Address (
address_id SERIAL PRIMARY KEY,
zip_code VARCHAR(100) NOT NULL CHECK (LENGTH(zip_code) >= 8),
town INTEGER NOT NULL,
FOREIGN KEY (town) REFERENCES lab7.Location(location_id) ON DELETE CASCADE
);

CREATE TYPE lab7.OrganisationType AS ENUM (
    'PUBLIC',
    'GOVERNMENT',
    'TRUST'
);

CREATE TABLE lab7.Organisation (
organisation_id SERIAL PRIMARY KEY,
address_id INTEGER NOT NULL,
user_id INTEGER,
coordinates_id INTEGER NOT NULL,
organisation_type lab7.OrganisationType NOT NULL,
...
FOREIGN KEY (address_id) REFERENCES lab7.Address(address_id) ON DELETE CASCADE,
FOREIGN KEY (user_id) REFERENCES lab7.User(user_id) ON DELETE CASCADE,
FOREIGN KEY (coordinates_id) REFERENCES lab7.Coordinates(coordinates_id)
);
...
INSERT INTO lab7.User (username, password, salt) VALUES
...
INSERT INTO lab7.Organisation (address_id, user_id, coordinates_id, organisation_type, name, annual_turnover, full_name) VALUES
